...
# Constants
    ...
    def gpt4_vision_analysis(image_path, api_key, summary, trans):
        ...
        json_form=str([json.dumps({"title":"Chapter 1: A new beginning","start_frame":"0.0s","end_frame":"253.55s","scenes":[{"title":"Scene 1: it started","description":"The thing happened, opening credits", "type":"credits"},{"title":"Scene 2: recap","description":"The thing happened,recap of previous episodes", "type":"recap"},{"title":"Scene 3: around again","description":"Another thing happened", "type":"content"}]}),json.dumps({"title":"Chapter 2: Next steps","start_frame":"253.55s","end_frame":"604.90s","scenes":[{"title":"Scene 1: new hope","description":"The thing happened", "type":"content"},{"title":"Scene 2: bad days","description":"Another thing happened", "type":"content"}]}),json.dumps({"title":"Chapter 3: conclusion","start_frame":"253.55s","end_frame":"604.90s","scenes":[{"title":"Scene 1: new hope","description":"The thing happened", "type":"content"},{"title":"Scene 2: bad days","description":"end credits start rolling", "type":"credits"}]})])
        if(vision_api_type=="Azure"):
            ...
            payload2 = {
                ...
                "messages": [
                    ...
                    Make sure you are correctly identifying scenes that represent recaps, content, credits, and end screens
    ...
    while cap.isOpened():
        ...
        if len(packet) == frames_per_interval or (current_interval_start_second + frame_interval) < current_second:
            ...
            #current_transcription=response["segments"]
